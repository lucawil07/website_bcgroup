...
const values = [
  {
    icon: CheckCircle2,
    title: 'Qualität',
    description: 'Höchste Standards bei jedem Auftrag – von der Planung bis zur Ausführung.',
  },
  {
    icon: Shield,
    title: 'Zuverlässigkeit',
    description: 'Pünktlich, verlässlich und immer für Sie da. Darauf können Sie sich verlassen.',
  },
  {
    icon: Star,
    title: 'Transparenz',
    description: 'Faire Preise, klare Kommunikation und keine versteckten Kosten.',
  },
  {
    icon: Clock,
    title: 'Flexibilität',
    description: 'Individuelle Lösungen und schnelle Reaktionszeiten für Ihre Bedürfnisse.',
  },
]
              ...
              <div className="absolute inset-0 p-6 md:p-8 lg:p-12 flex flex-col justify-end">
                <div className="space-y-4 md:space-y-6">
                  ...
                  <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-white uppercase leading-tight">
                    ...
                    <span className="text-secondary-light">ZUVERLÄSSIGKEIT</span>
                  </h2>
                  <p className="text-base md:text-lg text-white/90 leading-relaxed max-w-2xl">
                    Das sind die Grundwerte, auf denen unsere Arbeit basiert. Wir bei der BC Group 
                    glauben an ehrliche Partnerschaft und exzellenten Service.
                  </p>
                </div>
              </div>
            </div>
